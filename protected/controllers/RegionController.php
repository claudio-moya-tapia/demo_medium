...
class RegionController extends Controller {
    ...
    public function actionManage($id) {
       ...
       $model = new Region();
       $model->setAttribute('pais_id', $id);
       $modeloCiudad = Region::model()->findByPk($id);
       
       $criteria = new CDbCriteria;
       $criteria->addInCondition('pais_id', array($id));
       $listRegion = CHtml::listData(Region::model()->findAll($criteria), 'region_id','nombre');
