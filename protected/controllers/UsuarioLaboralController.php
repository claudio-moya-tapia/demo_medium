...
class UsuarioLaboralController extends Controller {
    ...
    public function actionList($id) {
        ...
        $criteria->compare('t.actual_id', '2');
        $criteria->order = 't.actual_id ASC';
        $aryUsuarioLaboral = UsuarioLaboral::model()
                ->with('usuario')
                ->with('empresa')
                ->with('industria')
        ...
        $this->render('list', array(
            'usuario'=>$usuario,
            'aryUsuarioLaboral' => $aryUsuarioLaboral,
        ));
    }
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('UsuarioLaboral');
    ...
    public function actionAdmin() {
        ...
        if (isset($_GET['UsuarioLaboral']))
            $model->attributes = $_GET['UsuarioLaboral'];
    ...
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'usuario-laboral-form') {
