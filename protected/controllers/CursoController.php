...
class CursoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		// $this->performAjaxValidation($model);
                $ListAreaAcademica = CHtml::listData(AreaAcademica::model()->findAll(), 'area_academica_id', 'titulo');
                $ListEsOptativo = CHtml::listData(EsOptativo::model()->findAll(), 'es_optativo_id', 'titulo');
               
                //UsuarioDocente::model()
                //->with('usuario')
                //->findAll()
                $ListDocente = CHtml::listData(UsuarioDocente::model()->with('usuario')->findAll(),'usuario_id','usuario.nombre');
                
		if(isset($_POST['Curso']))
		{
			$model->attributes=$_POST['Curso'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->curso_id));
		}
