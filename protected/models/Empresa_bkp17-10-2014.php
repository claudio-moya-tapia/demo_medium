...
class Empresa extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('empresa_id, pais_id, region_id, ciudad_id, comuna_id, tipo_sociedad_id, rut, razon_social, codigo_postal, giro_id, nombre, direccion, url, tipo_antiguedad_id, rango_empleado_id, rango_utilidad_id, rango_perdida_id, rango_facturacion_id, telefono_fijo, telefono_celular, telefono_fax,email', 'safe', 'on'=>'search'),
		);
	}
